          ...
          <a href="<?php echo BASE_URL ?>/admin" class="app-brand-link">
            <span class="app-brand-logo demo">
              <span style="color: var(--bs-primary)">
                <svg id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 289.54 355.29">
                  <defs>
                    <style>
                      .cls-1 {
                        fill: #515ba6;
