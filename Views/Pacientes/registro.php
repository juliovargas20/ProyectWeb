...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gestión de Pacientes / Listado de Pacientes / </span> Registro </h4>

    <!-- Form Paciente -->
    <div class="col-12">
        <div class="card">
            <h5 class="card-header">Registro de Paciente</h5>
            <div class="card-body">

                <form id="FrmRegistroPaciente" class="row g-3 needs-validation" novalidate autocomplete="off">
                    <!-- Datos Personales -->
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <button type="submit" id="BtnRegistroPaciente" class="btn btn-success">Guardar</button>
